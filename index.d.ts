...
export declare type DynamicClientExtensionThis<TypeMap extends TypeMapDef, TypeMapCb extends TypeMapCbDef, ExtArgs extends Record<string, any>> = {
  ...
  [P in Exclude<keyof TypeMap['other']['operations'], keyof ExtArgs['client']>]: <R = GetResult<TypeMap['other']['payload'], any, P & Operation>>(
...
export declare type DynamicModelExtensionFluentApi<TypeMap extends TypeMapDef, M extends PropertyKey, P extends PropertyKey, Null> = {
  [K in keyof TypeMap['model'][M]['payload']['objects']]: <A>(args?: Exact<A, Path<TypeMap['model'][M]['operations'][P]['args']['select'], [K]>>) => PrismaPromise<
    | Path<
...
> = {} extends TypeMap['model'][M]['operations'][P]['args']
  ? <A extends TypeMap['model'][M]['operations'][P]['args']>(args?: Exact<A, TypeMap['model'][M]['operations'][P]['args']>) => DynamicModelExtensionFnResult<TypeMap, M, A, P>
  : <A extends TypeMap['model'][M]['operations'][P]['args']>(args: Exact<A, TypeMap['model'][M]['operations'][P]['args']>) => DynamicModelExtensionFnResult<TypeMap, M, A, P>;
...
export declare type DynamicQueryExtensionCbArgs<TypeMap extends TypeMapDef, _0 extends PropertyKey, _1 extends PropertyKey, _2 extends PropertyKey> = (_1 extends unknown
  ? _2 extends unknown
    ? {
...
export declare type DynamicQueryExtensionCbArgsArgs<TypeMap extends TypeMapDef, _0 extends PropertyKey, _1 extends PropertyKey, _2 extends PropertyKey> = _2 extends
  | '$queryRaw'
  | '$executeRaw'
  ? Sql
...
export declare function getPrismaClient(config: GetPrismaClientConfig): {
  new (optionsArg?: PrismaClientOptions): {
     ...
     * @param options
     */
    _transactionWithArray({ promises, options }: { promises: Array<PrismaPromise_2<any>>; options?: BatchTransactionOptions | undefined }): Promise<any>;
    /**
     ...
     * @returns
     */
    _transactionWithCallback({ callback, options }: { callback: (client: Client) => Promise<unknown>; options?: Options_2 | undefined }): Promise<unknown>;
